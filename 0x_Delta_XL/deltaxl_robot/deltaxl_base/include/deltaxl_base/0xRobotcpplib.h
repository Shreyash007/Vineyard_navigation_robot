...
#define		ERROR_TRANSMIT			4
#define		ERROR_RECEIVE			8
#define		ERROR_RECEIVE_TIMEOUT	16
#define		ERROR_CHECKSUM			32
#define		ERROR_FAILURE_RESPONSE	64
#define		ERROR_ROBOT_CONNECT		128
...
public:
		...
		BOOL getStatus(void *hSerial, uint32 *puiStausArray);
		BOOL getStatus2(void* hSerial, uint8* pucStausArray);
		BOOL getRobotName(void *hSerial, uint8 *puiRobotNameArray, uint8 *pucNameSizeReceived, uint8 maxSize);
};
